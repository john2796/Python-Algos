...
# This is extremely inefficient because strings in Python are immutable
...
def reverse_string(s):
    # make them an array with two items call the split method
    arr = s.split()
    res = []
...
# Your code here
print(ascii_lowercase, 'alphabet <--')
alphabet_dict = {x: ascii_lowercase[x] for x in range(0 , len(ascii_lowercase))}
